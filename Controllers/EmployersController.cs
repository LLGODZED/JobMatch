...
namespace Jobmatch.Controllers
{
    public class EmployersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameCompany,Description,Username,Email,Phonenumber")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameCompany,Description,Username,Email,Phonenumber")] Employer employer)
        {
            if (id != employer.Id)
            {
                return NotFound();
